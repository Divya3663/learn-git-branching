...
This step shows creating a new branch called bugFix and switching to it, so now both main and bugFix point to the same commit, but bugFix is the active branch where new work will happen.
